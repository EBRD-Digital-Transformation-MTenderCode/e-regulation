...
class TemplateService(private val rulesService: RulesService,
    ...
    fun getStaticMetrics(country: String, pmd: String, language: String, mainProcurementCategory: String): Set<AgreedMetric> {
        when (MainProcurementCategory.fromValue(mainProcurementCategory)) {
            MainProcurementCategory.GOODS -> {
                ...
                val metrics = mutableSetOf<AgreedMetric>()
    ...
    fun getDynamicMetrics(country: String, pmd: String, language: String, mainProcurementCategory: String): Set<AgreedMetric> {
        when (MainProcurementCategory.fromValue(mainProcurementCategory)) {
            MainProcurementCategory.GOODS -> {
